      ...
      <div className="relative">
        ...
        {searchTerm && (
          <button
            type="button"
            onClick={clearSearch}
            className="absolute right-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors"
          >
            <X className="size-4" />
          </button>
        )}
        ...
        <div className="mt-2 bg-card border border-border rounded-lg shadow-lg max-h-96 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="p-4 text-center text-muted-foreground">
              ...
              <p>No Users found matching &qauot;{searchTerm}&quot;</p>
            </div>
          ) : (
            <div className="py-2">
